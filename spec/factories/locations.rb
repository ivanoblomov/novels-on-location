...
FactoryBot.define do
  ...
  trait :from_hell do
    ...
    image_height { '75' }
    image_url { 'https://ecx.images-amazon.com/images/I/51OytRMAizL._SL75_.jpg' }
    image_width { '56' }
    ...
    url { 'https://www.amazon.com/Hell-Alan-Moore/dp/0958578346%3FSubscriptionId%3DAKIAINFSZKSQ4ZTKFDZA%26tag%3Dws%26linkCode%3Dxm2%26camp%3D2025%26creative%3D165953%26creativeASIN%3D0958578346' }
    user_id { '666325406' }
  ...
  trait :sun_also_rises do
    ...
    country { 'Spain' }
    image_height { '75' }
    image_url { 'https://ecx.images-amazon.com/images/I/413SnoVxOxL._SL75_.jpg' }
    image_width { '49' }
    ...
    url { 'https://www.amazon.com/Sun-Also-Rises-Ernest-Hemingway/dp/0743297334%3FSubscriptionId%3DAKIAINFSZKSQ4ZTKFDZA%26tag%3Dws%26linkCode%3Dxm2%26camp%3D2025%26creative%3D165953%26creativeASIN%3D0743297334' }
    user_id { '666325406' }
    user_token { 'suwWgD82Ucp00DysVNFuGxHWGtvjF9ns8238IK3V3/I=' }
  end
end
